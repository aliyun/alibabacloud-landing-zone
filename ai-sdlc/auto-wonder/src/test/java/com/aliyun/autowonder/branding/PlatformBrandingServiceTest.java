...
class PlatformBrandingServiceTest {
    ...
    void publicConfigFallsBackWhenDatabaseRowIsMissing() {
        ...
        assertEquals("0.2.117", config.getRecommendedRuntimeVersion());
    ...
    void rejectsMissingDeploymentPublicBaseUrl() {
        ...
        assertThrows(IllegalStateException.class,
                () -> new PlatformBrandingService(dao, new InMemoryObjectStorage(), props, "", "0.2.117"));
    }
    ...
    void rejectsPublicBaseUrlWithQueryOrFragment() {
        ...
        assertThrows(IllegalStateException.class,
                () -> new PlatformBrandingService(
                        dao, new InMemoryObjectStorage(), props, "https://daily.example.com?x=1", "0.2.117"));
        assertThrows(IllegalStateException.class,
                () -> new PlatformBrandingService(
                        dao, new InMemoryObjectStorage(), props, "https://daily.example.com#anchor", "0.2.117"));
    }
    ...
    private static PlatformBrandingService newService(
        ...
        return new PlatformBrandingService(
                dao, storage, props, "https://daily.auto-wonder.example.com", "0.2.117");
    }

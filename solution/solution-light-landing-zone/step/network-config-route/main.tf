  ...
  transit_router_route_entry_config = [
    {
      ...
      route_entry_name          = "biz-vpc-to-shared-vpc"
      route_entry_description   = "biz-vpc-to-shared-vpc"
      ...
      route_entry_next_hop_type = "Attachment"
      route_entry_name          = "default-to-shared-vpc"
      route_entry_description   = "default-to-shared-vpc"
      route_entry_next_hop_id   = local.shared_service_account_vpc_attachment_id
    }
  ]
}
  ...
  transit_router_route_entry_config = [
    {
      route_entry_dest_cidr     = local.shared_service_account_vpc_config.vpc_cidr
      route_entry_next_hop_type = "Attachment"
      route_entry_name          = "management-vpc-to-shared-vpc"
      route_entry_description   = "management-vpc-to-shared-vpc"
      route_entry_next_hop_id   = local.shared_service_account_vpc_attachment_id
    }, {
      route_entry_dest_cidr     = "0.0.0.0/0"
      route_entry_next_hop_type = "Attachment"
...
module "dev_account_vpc_custom_route" {
  ...
  route_entry_config = [
    {
      destination_cidrblock = local.shared_service_account_vpc_config.vpc_cidr
      nexthop_type          = "Attachment"

...
# Region
light_landingzone_region  = "cn-shanghai"
management_account_id     = ""
payer_account_id          = ""


# 如果是通过云治理中心搭建的话Account information 通过云治理中心搭建出来的账号结构
log_account_id            = ""
...
# CloudSSO Identity, Get it from CGC
cloudsso_directory_name   = "hybridsso"
...
ram_user_initial_pwd         = "your-initial-password"
...
security_account_ram_users = [
  {
    ...
    "enable_console_login" = false
    "enable_api_access"    = true
    "system_policy"        = ["AliyunYundunCloudFirewallFullAccess", "AliyunCSASFullAccess", "AliyunYundunSASFullAccess",
...
config_aggregator_name    = "TagPolicyRdAggregatormQQqwtxeZpvFjYXtFMde"
...
ecs_instance_password              = "your-ecs-password"
# production vpc
...
ops_vpc_ecs_instance_deploy_config = [
  {
    instance_name = "ecs-ops-sh-1"
    host_name     = "ecs-ops-sh-1"
    description   = "ecs-ops-sh-1"
  }
]
...
dev_vpc_alb_instance_name = "alb-tf-dev-default"

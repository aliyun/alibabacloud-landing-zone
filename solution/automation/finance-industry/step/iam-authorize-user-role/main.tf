locals {
  ...
  management_account_ram_roles     = var.management_account_ram_roles
  log_account_ram_users            = var.log_account_ram_users
  log_account_ram_roles            = var.log_account_ram_roles
  shared_service_account_ram_users = var.shared_service_account_ram_users
  shared_service_account_ram_roles = var.shared_service_account_ram_roles
  security_account_ram_users       = var.security_account_ram_users
  security_account_ram_roles       = var.security_account_ram_roles
  ...
  dev_account_ram_roles            = var.dev_account_ram_roles
...
module "management_account_ram_authorize_user_role" {
  ...
  ram_roles = local.management_account_ram_roles
}
...
module "log_account_ram_authorize_user_role" {
  ...
  ram_roles = local.log_account_ram_roles
}
...
module "shared_service_account_ram_authorize_user_role" {
  ...
  ram_roles = local.shared_service_account_ram_roles
}
...
module "security_account_ram_authorize_user_role" {
  ...
  ram_roles = local.security_account_ram_roles
}
...
module "ops_account_ram_authorize_user_role" {
  ...
  ram_roles = local.ops_account_ram_roles
}
...
module "dev_account_ram_authorize_user_role" {
  ...
  ram_roles = local.dev_account_ram_roles
}
...
module "prod_account_ram_authorize_user_role" {
  ...
  ram_roles = local.prod_account_ram_roles
}